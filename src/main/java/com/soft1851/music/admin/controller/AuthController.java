...
public class AuthController {
    ...
    public void getUser(@RequestParam("code") String code){
        ...
        try {
            ...
            list.add(new BasicNameValuePair("client_id", "97b4b68b2083934d520f"));
            list.add(new BasicNameValuePair("client_secret", "dc7b4db9ec73b8c5c5a202161fb370f3de7535f9"));
            ...
            response.sendRedirect("http://localhost:8888/#/auth?user=" + user);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
